package com.example.reueljohn.customfancontroller;
...
public class DialView extends  android.view.View {
    ...
    private void init() {
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAcitveSelection = (mAcitveSelection + 1) % SELECTION_COUNT;
                // Set dial background color to green if selection is >= 1.
                if (mAcitveSelection >= 1) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float[] xyData = computeXYForPosition(mAcitveSelection,
                markerRadius);
        float x = xyData[0];
        float y = xyData[1];
